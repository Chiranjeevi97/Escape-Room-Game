...
public class BaseActor extends Group
{
    ...
    public void fire()
    {
        ...
        Fire bullet = new Fire(0,0, this.getStage());
    ...
    public void bomb()
    {
        ...
        Bomber bomb = new Bomber(0,0, this.getStage());
        bomb.centerAtActor(this);
        bomb.setMotionAngle(90);
    }
    ...
    public void drop()
    {
        ...
        Waterdrops drop = new Waterdrops(0,0, this.getStage());
        drop.centerAtActor(this);
        drop.setMotionAngle(270);
    }
